...
# Full broker smile: (tenor_years, ATM, 25d RR, 25d BF, 10d RR, 10d BF).
# 25d/10d butterflies are market strangles. Safe-haven skew: RR favours USD puts / CHF calls.
USDCHF_SMILE_QUOTES = [
    (7 / 365, 0.0635, -0.0030, 0.0012, -0.0055, 0.0044),
    (14 / 365, 0.0655, -0.0038, 0.0014, -0.0070, 0.0049),
    (1 / 12, 0.0680, -0.0048, 0.0016, -0.0090, 0.0055),
    (2 / 12, 0.0700, -0.0058, 0.0018, -0.0112, 0.0060),
    (3 / 12, 0.0710, -0.0066, 0.0019, -0.0128, 0.0064),
    (6 / 12, 0.0730, -0.0078, 0.0021, -0.0150, 0.0070),
    (9 / 12, 0.0742, -0.0085, 0.0022, -0.0162, 0.0073),
    (1.00, 0.0752, -0.0092, 0.0023, -0.0173, 0.0076),
    (1.50, 0.0768, -0.0100, 0.0024, -0.0185, 0.0079),
    (2.00, 0.0780, -0.0106, 0.0025, -0.0196, 0.0082),
]
